...
const FEATHER_DEFAULT = 9;

// RNG simple y determinístico
...
export default function Ground({
  ...
  const material = useMemo(() => {
    ...
    const mExt = m as THREE.MeshStandardMaterial & {
